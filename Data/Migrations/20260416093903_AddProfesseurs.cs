...
{
    /// <inheritdoc />
    public partial class AddProfesseurs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfesseurSections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProfesseurSections_Professeurs_ProfesseurId",
                        column: x => x.ProfesseurId,
                        principalTable: "Professeurs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProfesseurSections_Sections_SectionId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProfesseurSections_ProfesseurId",
                table: "ProfesseurSections",
                column: "ProfesseurId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfesseurSections_SectionId",
                table: "ProfesseurSections",
                column: "SectionId");
        }
